...
| -------- | --------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| AUTH-01  | Public signup, forged invite, or permissive redirect URL creates an administrator                         | Disable public signup; invite through trusted server/Dashboard; exact production redirect allowlist; do not assign privilege from invitation metadata                                                                                                                | Alert on user creation and role assignment; disable account and revoke sessions                   |
